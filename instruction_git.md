...
<<<<<<< HEAD
произойдет конфликт слияния 
=======
Если при слиянии веток произойдет конфликт слияния (merge conflict), то выбрать одну из версий файла, вручную разрешить конфликты, отредактировать конфликтный файл, удалить метки.
>>>>>>> merge_conflict
